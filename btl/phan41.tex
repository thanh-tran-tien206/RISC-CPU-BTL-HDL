...
Dự án được tổ chức theo mô hình phân cấp module (\textit{Modular Design}), mỗi khối chức năng tương ứng với một file Verilog riêng biệt, kèm theo Testbench độc lập để kiểm thử từng khối trước khi tích hợp hệ thống.
...
|   +-- memory.v                # Khoi Memory (Single bidirectional port)
|   +-- controller.v            # Khoi Controller (FSM 8 trang thai)
